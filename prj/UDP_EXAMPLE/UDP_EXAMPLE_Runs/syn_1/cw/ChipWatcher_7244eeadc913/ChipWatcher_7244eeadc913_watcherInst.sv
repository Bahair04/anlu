module ChipWatcher_7244eeadc913 ( 
    ...
    localparam CWC_BUS_DIN_NUM = 113;
    localparam CWC_CTRL_LEN = 394;
	localparam CWC_BUS_CTRL_LEN = 374;
    localparam INPUT_PIPE_NUM = 0;
    localparam OUTPUT_PIPE_NUM = 0;
	localparam CWC_CAPTURE_CTRL_EXIST = 0;
    localparam RAM_LEN = 113;
    localparam RAM_DATA_DEPTH = 1024;
    localparam STAT_REG_LEN = 24;
    localparam integer CWC_BUS_WIDTH[0:CWC_BUS_NUM-1] = { 16,1,1,10,25,8,2,25,16,1,8 };
    localparam integer CWC_BUS_DIN_POS[0:CWC_BUS_NUM-1] = { 0,16,17,18,28,53,61,63,88,104,105 };    
    localparam integer CWC_BUS_CTRL_POS[0:CWC_BUS_NUM-1] = { 0,52,56,60,94,173,201,211,290,342,346 };
