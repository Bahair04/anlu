module ChipWatcher_c3b5d90bce19 ( 
    ...
    localparam CWC_CTRL_LEN = 84;
	localparam CWC_BUS_CTRL_LEN = 64;
    ...
    localparam integer CWC_BUS_WIDTH[0:CWC_BUS_NUM-1] = { 16,1,1,1 };
    localparam integer CWC_BUS_DIN_POS[0:CWC_BUS_NUM-1] = { 0,16,17,18 };    
    localparam integer CWC_BUS_CTRL_POS[0:CWC_BUS_NUM-1] = { 0,52,56,60 };
